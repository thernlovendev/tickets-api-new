...
/**
 * This class stands for NewOrderResult StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class NewOrderResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    protected $any = null;
    /**
     * Constructor method for NewOrderResult
     * @uses NewOrderResult::setSchema()
     * @uses NewOrderResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\NewOrderResult
     */
