...
/**
 * This class stands for PerformancesPOHPricesAvailabilityMCResult StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class PerformancesPOHPricesAvailabilityMCResult extends AbstractStructBase
{
    /**
     * The schema
     ...
     * @uses PerformancesPOHPricesAvailabilityMCResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\PerformancesPOHPricesAvailabilityMCResult
     */
