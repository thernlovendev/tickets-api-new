...
/**
 * This class stands for CityListResult StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class CityListResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    public $any = null;
    /**
     * Constructor method for CityListResult
     * @uses CityListResult::setSchema()
     * @uses CityListResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\CityListResult
     */
