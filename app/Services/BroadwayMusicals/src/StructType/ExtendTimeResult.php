...
/**
 * This class stands for ExtendTimeResult StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ExtendTimeResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    protected $any = null;
    /**
     * Constructor method for ExtendTimeResult
     * @uses ExtendTimeResult::setSchema()
     * @uses ExtendTimeResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\ExtendTimeResult
     */
