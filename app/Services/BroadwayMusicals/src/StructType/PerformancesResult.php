...
/**
 * This class stands for PerformancesResult StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class PerformancesResult extends AbstractStructBase
{
    /**
     * The schema
     ...
     * @uses PerformancesResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\PerformancesResult
     */
