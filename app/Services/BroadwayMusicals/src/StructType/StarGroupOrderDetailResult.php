...
/**
 * This class stands for StarGroupOrderDetailResult StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class StarGroupOrderDetailResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    protected $any = null;
    /**
     * Constructor method for StarGroupOrderDetailResult
     * @uses StarGroupOrderDetailResult::setSchema()
     * @uses StarGroupOrderDetailResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\StarGroupOrderDetailResult
     */
