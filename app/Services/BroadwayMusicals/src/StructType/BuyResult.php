...
/**
 * This class stands for BuyResult StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class BuyResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    public $any = null;
    /**
     * Constructor method for BuyResult
     * @uses BuyResult::setSchema()
     * @uses BuyResult::setAny()
