...
/**
 * This class stands for ShowBasicsResult StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ShowBasicsResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    protected $any = null;
    /**
     * Constructor method for ShowBasicsResult
     * @uses ShowBasicsResult::setSchema()
     * @uses ShowBasicsResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\ShowBasicsResult
     */
