...
/**
 * This class stands for ShowDetailsResult StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ShowDetailsResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    protected $any = null;
    /**
     * Constructor method for ShowDetailsResult
     * @uses ShowDetailsResult::setSchema()
     * @uses ShowDetailsResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\ShowDetailsResult
     */
