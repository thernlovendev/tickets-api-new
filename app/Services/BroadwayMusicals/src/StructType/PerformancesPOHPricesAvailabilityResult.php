...
/**
 * This class stands for PerformancesPOHPricesAvailabilityResult StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class PerformancesPOHPricesAvailabilityResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    public $any = null;
    /**
     * Constructor method for PerformancesPOHPricesAvailabilityResult
     * @uses PerformancesPOHPricesAvailabilityResult::setSchema()
     * @uses PerformancesPOHPricesAvailabilityResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\PerformancesPOHPricesAvailabilityResult
     */
