...
/**
 * This class stands for PremiumSeatsResult StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class PremiumSeatsResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    protected $any = null;
    /**
     * Constructor method for PremiumSeatsResult
     * @uses PremiumSeatsResult::setSchema()
     * @uses PremiumSeatsResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\PremiumSeatsResult
     */
