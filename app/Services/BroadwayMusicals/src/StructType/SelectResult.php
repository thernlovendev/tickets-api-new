...
/**
 * This class stands for SelectResult StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SelectResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    public $any = null;
    /**
     * Constructor method for SelectResult
     * @uses SelectResult::setSchema()
     * @uses SelectResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\SelectResult
     */
