                    ...
                    if(!isset($sub_item['id'])){
                        ...
                        switch ($ticket->ticket_type) {
                            case Ticket::TYPE['REGULAR']:
                                ...
                                } else if ($old_sub_item['ticket_sent_status'] == ReservationSubItem::SEND_STATUS['SENT'] && $sub_item['refund_status'] = ReservationSubItem::TICKET_REFUNDED_STATUS['REFUNDED'] || $sub_item['refund_status'] = ReservationSubItem::TICKET_REFUNDED_STATUS['IN_PROGRESS'] || $sub_item['refund_status'] = ReservationSubItem::TICKET_REFUNDED_STATUS['PICKED_UP']){
