...
<head>
    ...
    <title>{{__('Delete User Mail')}}</title>
    <style>
                    ...
                    <td style="padding: 4px;">
                        ...
                        <a style="margin: 0;
                                    ...
                                    margin-right: 6.6em" href="{{ env('APP_URL_WEB_PAGE') }}/webpage/56">
                                        <img style="margin-left: 50px;" src="https://testing.thernloven.com/tickets-api-new/public/images/dollar-circle.svg" alt="icon Money" >
                            </a>
                            <br>
