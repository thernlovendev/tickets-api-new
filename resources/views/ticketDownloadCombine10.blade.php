    ...
    <body>
        ...
        <div style="position:relative;">
            <div style="position: relative;margin-bottom:50px">
                ...
                @elseif($type == 'Bar')
                <div style="position: absolute; top: 32px; left: 284px;"> 
                <span style="font-size:10px">{!! DNS1D::getBarcodeHTML("$code", 'C39',2,48) !!}</span>
                
                </div>

                <div style="position: absolute; top: 75px; left: 425px;"> 
                <span style="font-weight:800">{{$code}}</span>
                
                </div>

                <div style="position: absolute; top: 95px; left: 509x;"> 
                    <span style="font-weight:800">Expiration: {{$expiration_date}}</span><br>
                    {{-- <span style="font-weight:800">{{$reservation->customer_name_en}}</span> --}}
                ...
                @elseif($type == 'Text')
                 ...
                 <div style="position: absolute; top: 38px; left: 572px;"> 
                <span style="font-weight:800">{{$code}}</span>
